   ...
   <div class="navbar-header">
      <a href="dashboard.html" class="navbar-brand">
         <div class="brand-logo">
            <img src="{{ asset('admin/app/img/logo.png')}}" alt="App Logo" class="img-responsive">
         </div>
         <div class="brand-logo-collapsed">
            <img src="{{ asset('admin/app/img/logo-single.png')}}" alt="App Logo" class="img-responsive">
         </div>
      </a>
   </div>
   <!-- END navbar header-->
                  ...
                  <div class="scroll-viewport">
                     ...
                     <div class="list-group scroll-content">
                        ...
                        <a href="#" class="list-group-item">
                           <div class="media">
                              <div class="pull-left">
                                 <img src="{{ asset('admin/app/img/user/01.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                              </div>
                        ...
                        <a href="#" class="list-group-item">
                           <div class="media">
                              <div class="pull-left">
                                 <img src="{{ asset('admin/app/img/user/04.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                              </div>
                              <div class="media-body clearfix">
                        ...
                        <a href="#" class="list-group-item">
                           <div class="media">
                              <div class="pull-left">
                                 <img src="{{ asset('admin/app/img/user/03.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                              </div>
                              <div class="media-body clearfix">
