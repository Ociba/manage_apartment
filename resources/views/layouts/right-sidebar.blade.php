            ...
            <ul class="nav">
                  ...
                  <div class="item">
                     <div class="p-lg">
                        <div class="text-center">
                           <p>
                              <img src="{{ asset('admin/app/img/user/02.jpg')}}" alt="Image" class="img-circle img-thumbnail thumb64">
                           </p>
                           <p>
               ...
               <li>
                  ...
                  <a href="#" class="media p mt0">
                     ...
                     <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="{{ asset('admin/app/img/user/05.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                     </span>
                     <!-- Contact info-->
                  ...
                  <a href="#" class="media p mt0">
                     ...
                     <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="{{ asset('admin/app/img/user/06.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                     </span>
                     <!-- Contact info-->
                     <span class="media-body">
                        <span class="media-heading">
                  ...
                  <a href="#" class="media p mt0">
                     ...
                     <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="{{ asset('admin/app/img/user/07.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                     </span>
                     <!-- Contact info-->
                     <span class="media-body">
                        <span class="media-heading">
                  ...
                  <a href="#" class="media p mt0">
                     ...
                     <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="{{ asset('admin/app/img/user/08.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                     </span>
                     <!-- Contact info-->
                     <span class="media-body">
                        <span class="media-heading">
               ...
               <li>
                  ...
                  <a href="#" class="media p mt0">
                     ...
                     <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="{{ asset('admin/app/img/user/09.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                     </span>
                     <!-- Contact info-->
                     <span class="media-body">
                        <span class="media-heading">
                  ...
                  <a href="#" class="media p mt0">
                     ...
                     <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="{{ asset('admin/app/img/user/10.jpg')}}" alt="Image" class="media-object img-circle thumb48">
                     </span>
                     <!-- Contact info-->
                     <span class="media-body">
                        <span class="media-heading">
